...
{
	this->materials.push_back(new Material(glm::vec3(0.4f), glm::vec3(1.f), glm::vec3(0.5f)));
}
...
void Game::initModels()
{
	...
	this->models.push_back(new Model(glm::vec3(0.f, 0.f, -70.0f), this->materials[0], "OBJFiles/plane_propel.obj", glm::vec3(0.f, 180.f, 0.f), glm::vec3(0.1f)));
}
...
void Game::ProcessInput(GLFWwindow* window)
{
	if (glfwGetKey(window, GLFW_KEY_J) == GLFW_PRESS)
		this->models[0]->eularAngles(2.0f, 0.0f, 0.0f);
	if (glfwGetKey(window, GLFW_KEY_K) == GLFW_PRESS)
		this->models[0]->eularAngles(0.0f, 2.0f, 0.0f);
	if (glfwGetKey(window, GLFW_KEY_L) == GLFW_PRESS)
		this->models[0]->eularAngles(0.0f, 0.0f, 2.0f);
	if (glfwGetKey(window, GLFW_KEY_Y) == GLFW_PRESS)
		this->models[0]->QAngle(5.0f, glm::vec3(1.0f, 0.0f, 0.0f));
	if (glfwGetKey(window, GLFW_KEY_U) == GLFW_PRESS)
		this->models[0]->QAngle(5.0f, glm::vec3(0.0f, 1.0f, 0.0f));
	if (glfwGetKey(window, GLFW_KEY_I) == GLFW_PRESS)
		this->models[0]->QAngle(5.0f, glm::vec3(0.0f, 0.0f, 1.0f));
}
